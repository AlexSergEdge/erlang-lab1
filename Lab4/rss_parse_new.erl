...
% функция проверяет, что формат данных - RSS 2.0
is_rss2_feed(XML) ->
    VerXPath = "@version",
...
% получает две записи #xmlElement, представляющие элементы RSS ленты
% возвращает атом, созданный на основе сравнения старых и новых элементов ленты
